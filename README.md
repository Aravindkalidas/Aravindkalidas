...
* **Cloud Platforms:** AWS (EC2, VPC, S3, RDS, Lambda, IAM, CloudWatch, Route53, EFS, CloudFront, NLB, EBS), Microsoft Azure (VMs, VNet, Resource Groups, Storage Accounts, Azure Monitor, Site Recovery, Subscriptions, VNG, LNG).
* **Operating Systems:** Red Hat Enterprise Linux (RHEL 10) Administration, Windows Server.
* **System Admin & Automation:** Package Management, Yum Server, LVM, RAID, AT/Cron scheduling, Bash/Shell scripting basics, Ansible (exposure).
...
* Administered RHEL 10 servers, including package management, configuration of LVM/RAID, and task automation via AT and Cron.
* Deployed and managed web services including Apache HTTP, Nginx, Mail Server, and Samba.
* Provisioned 10+ AWS services to architect secure cloud environments, focusing on VPC networking, EC2 scaling, and storage solutions (EBS/EFS/S3).
...
* **Bachelor of Engineering (Aeronautical Engineering)** | Nehru Institute of Engineering & Technology, Coimbatore | CGPA: 7.37
* **Higher Secondary Education (Bio-Maths)** | Chavara Vidya Bhavan, Coimbatore | 68%
* **Secondary School Education** | Graham Staines Matriculation School, Coimbatore | 92%
...
**SOFT SKILLS**
Analytical Thinking, Troubleshooting, Team Collaboration, Adaptability, Problem Solving, Technical Communication, Time Management, Continuous Learning.
